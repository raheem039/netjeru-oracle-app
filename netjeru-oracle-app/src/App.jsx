...
import { CATEGORIES, PULL_TYPES, CREDIT_PACKS, SUBSCRIPTION, RARITY_CONFIG } from './data/deities';
...
export default function App() {
  ...
  const handlePull = useCallback(() => {
    ...
    const reading = generateReading(category, pullType);
    setCards(reading);
    ...
    <div className="app">
      ...
      <header className="app-header">
        ...
        <div className="header-right">
          ...
          >
            📿 {Object.keys(gameState.collection).length}/13
          </button>
        </div>
      </header>
      ...
      <div className="status-bar">
        {gameState.isSubscriber ? (
          ...
          <span className="status-free">
            ✦ {gameState.freeRoundsRemaining} FREE PULL{gameState.freeRoundsRemaining !== 1 ? 'S' : ''} REMAINING
          </span>
        ) : (
        ...
        {screen === SCREENS.HOME && (
          <div className="screen screen-home">
            ...
            <div className="home-stats">
              ...
              <div className="stat">
                <span className="stat-value">{Object.keys(gameState.collection).length}</span>
                <span className="stat-label">Deities Found</span>
              </div>
              <div className="stat">
                <span className="stat-value">{Math.round((Object.keys(gameState.collection).length / 13) * 100)}%</span>
